package com.example.SpringEsercizio11;

import com.example.SpringEsercizio11.controllers.StudentController;
...
class StudentControllerTest {
    ...
    void readOneStudent() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(get("/v1/getSingle/" + student.getId()))
                .andDo(print())
                .andExpect(status().isOk())
                .andReturn();
    ...
    void updateStudent() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(put("/v1/patch/" + student.getId())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(studentJSON)).andDo(print())
                .andExpect(status().isOk())
                .andReturn();
    ...
    void deleteStudent() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(delete("/v1/" + student.getId()))
                .andDo(print())
                .andExpect(status().isOk())
                .andReturn();
